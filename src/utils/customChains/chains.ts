...
export const UbitTestnet: Chain = {
  id: 44433,
  name: "UBIT Testnet",
  iconUrl: "https://s2.coinmarketcap.com/static/img/coins/200x200/14914.png",
  iconBackground: "#fff",
  nativeCurrency: {
    name: "USC (UBIT CHAIN)",
    symbol: "tUSC",
...
export const KakarotSepolia: Chain = {
  ...
  iconUrl: "https://evmlord.dev/images/kakarot-twitter-pfp.png",
  iconBackground: "#fff",
  nativeCurrency: {
    name: "Ethereum",
    symbol: "ETH",
...
export const ThetaTestnet: Chain = {
  id: 365,
  name: "Theta Testnet",
  iconUrl: "https://s2.coinmarketcap.com/static/img/coins/200x200/3822.png",
  iconBackground: "#fff",
  nativeCurrency: {
    name: "Theta Fuel",
    symbol: "TFUEL",
...
export const MainnetZTestnet: Chain = {
  ...
  iconUrl: "https://s2.coinmarketcap.com/static/img/coins/200x200/28659.png",
  nativeCurrency: {
    name: "tMainnetZ",
    symbol: "tNetZ",
    decimals: 18,
